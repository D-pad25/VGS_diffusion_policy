...
class RealXArm6ImageDataset(BaseImageDataset):
    ...
    def __init__(self,
        ...
        self._store_keepalive = replay_buffer
    ...
    def __del__(self):
        try:
            if hasattr(self, "_store_keepalive") and isinstance(self._store_keepalive, ZarrReplayBufferView):
                self._store_keepalive.close()
        except Exception:
            pass
